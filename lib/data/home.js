...
export const stats = [
  ...
  { value: 89, suffix: '', label: 'leads/mois générés' },
...
export const pricing = [
  {
    name: 'Starter',
    price: { monthly: 3500, yearly: 2975 },
    target: 'Auto-entrepreneurs & freelances',
    desc: 'Idéal pour démarrer votre présence digitale et générer vos premiers leads qualifiés.',
    features: [
      '1 canal publicitaire (Meta OU Google)',
      'Landing page optimisée incluse',
      'Setup CRM basique',
      'Reporting mensuel',
      'Support WhatsApp',
    ],
  ...
  {
    name: 'Growth',
    price: { monthly: 7000, yearly: 5950 },
    target: 'PME, restaurants, cliniques',
    desc: 'La solution complète pour scaler votre acquisition client et automatiser votre suivi.',
    features: [
      'Meta Ads + Google Ads',
      'Site web ou landing pages',
      'CRM WePushX complet',
      'Automation WhatsApp & email',
      'SEO local (3 mots-clés)',
  ...
  {
    name: 'Scale',
    price: { monthly: 15000, yearly: 12750 },
    target: 'E-commerce, startups',
    desc: 'Stratégie digitale complète pour les entreprises prêtes à dominer leur marché.',
    features: [
      'Tous canaux publicitaires',
      'Site e-commerce complet',
      'UGC IA (10 vidéos/mois)',
      'CRM + Chatbot IA avancé',
      'SEO national (10+ mots-clés)',
      'Community management',
      'Reporting temps réel (dashboard)',
    ],
...
export const results = [
  {
    ...
    detail: 'SEO local + Google Ads — 6 mois',
  },
  {
    sector: 'Clinique Médicale',
    metric: '89',
    label: 'leads/mois générés',
    detail: 'Site + Meta Ads + CRM — 3 mois',
  },
  {
    sector: 'E-commerce Mode',
    metric: '-42%',
    label: 'coût d\'acquisition',
    detail: 'UGC IA + Meta Ads — 4 mois',
  },
]
...
export const faqs = [
  ...
  },
  {
    ...
    a: 'C\'est un appel de 30 minutes. On analyse votre situation actuelle (publicités, site, SEO, CRM), on identifie vos problèmes et on vous explique exactement quoi faire. Sans engagement.',
  },
]
